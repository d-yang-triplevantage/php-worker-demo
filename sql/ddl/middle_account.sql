...
DROP TABLE IF EXISTS "middle_account";
DROP SEQUENCE IF EXISTS middle_account_id_seq;
CREATE SEQUENCE middle_account_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1;
