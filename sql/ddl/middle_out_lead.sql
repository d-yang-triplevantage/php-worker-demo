...
DROP TABLE IF EXISTS "middle_out_lead";
DROP SEQUENCE IF EXISTS middle_out_lead_id_seq;
CREATE SEQUENCE middle_out_lead_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1;
