...
//・小文字は大文字に変換
$tmp_strAccountNameToUpper=mb_strtoupper($strAccountName);
//・半角はすべて全角に変換
$tmp_strAccountName=mb_convert_kana($tmp_strAccountNameToUpper);
...
$nameEditResult = trim(str_replace($search,$replace,$tmp_strAccountName));

 return  $nameEditResult;
