  ...
  foreach ($stmt as $row) {
      //指定Columnを一覧表示
        ...
        if($vctr__shareng__c != ' '){
            ...
            //他社共有データをマスタテーブル登録
                $prepIns002 = $dbh->prepare('INSERT INTO sfdcmiddle.middle_out_opportunity(id,sfid,schema,accountid,name,contactid,vctr__ownercompany__c,vctr__shareng__c,vctr__vectorno__c) VALUES(:id,:sfid,:tasyaschema,:opp_accountid,:name,:opp_contactid,:vctr__ownercompany__c,:vctr__shareng__c,:vctr__vectorno__c)');
