...
try{
  ...
  foreach ($stmt as $row) {
    ...
    // }else{
     ...
     //      $lastname=$keynew[1];
     //      $email=$keynew[2];
           $prepIns = $dbh->prepare('INSERT INTO sfdcmaster.master_lead(sfid,firstname,lastname,email,phone,vctr__vectorno__c) VALUES(:sfid,:firstname,:lastname,:email,:phone:vctr__vectorno__c)');
