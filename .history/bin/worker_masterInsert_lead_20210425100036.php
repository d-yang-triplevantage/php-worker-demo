...
try{
  ...
  $sql = 'select a.sfid as asfid,a.schema as aschema,b.sfid as bsfid,b.schema as bschema,b.lastname as blastname,b.firstname as bfirstname,b.email as bemail,b.phone as bphone from sfdcmiddle.middle_lead a ,sfdcmiddle.middle_lead b
  ...
  foreach ($stmt as $row) {
    ...
    // }else{
     ...
     //      $lastname=$keynew[1];
     //      $email=$keynew[2];
           $prepIns = $dbh->prepare('INSERT INTO sfdcmaster.master_lead(sfid,firstname,lastname,email,phone,vctr__vectorno__c) VALUES(:asfid,:firstname,:lastname,:email,:phone,:vctr__vectorno__c)');
           $prepIns->execute(array($asfid,$firstname,$lastname,$email,$phone,$vctr__vectorno__c));
