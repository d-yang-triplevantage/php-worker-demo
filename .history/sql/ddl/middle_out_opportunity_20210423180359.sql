...
DROP TABLE IF EXISTS "sfdcmiddle"."middle_out_opportunity";
DROP SEQUENCE IF EXISTS "sfdcmiddle"."middle_out_opportunity_id_seq";
CREATE SEQUENCE "sfdcmiddle"."middle_out_opportunity_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1;
