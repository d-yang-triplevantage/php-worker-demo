...
DROP TABLE IF EXISTS "sfdcmiddle"."middle_lead";
DROP SEQUENCE IF EXISTS "sfdcmiddle"."middle_lead_id_seq";
CREATE SEQUENCE "sfdcmiddle"."middle_lead_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1;
