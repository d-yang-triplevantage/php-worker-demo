...
DROP TABLE IF EXISTS "master_company__c";
DROP SEQUENCE IF EXISTS master_company__c_id_seq;
CREATE SEQUENCE master_company__c_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1;
