...
try{
  ...
  foreach ($stmt as $row) {
     ...
     //   $vctr__contact__c_U = $row['vctr__contact__c'];
        ...
        $prepIns = $dbh->prepare('INSERT INTO '.$schemaid.' (id,sfid,accountid,name,contactid,vctr__ownercompany__c,vctr__shareng__c,vctr__account__c,vctr__vectorno__c) VALUES(:id,:sfid,:accountid,:name,:contactid,:vctr__ownercompany__c,:vctr__shareng__c,:vctr__account__c,:vctr__vectorno__cI)
